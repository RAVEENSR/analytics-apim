...
public class GDPRClientConfiguration {
    ...
    @Element(description = "pseudonym which is used to replace the username", required = true)
    private String pseudonym;

    @Element(description = "tenant domain of the user", required = true)
    private String tenantDomain;

    @Element(description = "email of the user", required = true)
    private String userEmail;

    @Element(description = "ip address of the user", required = true)
